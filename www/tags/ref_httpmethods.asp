...
<!-- Mirrored from www.w3schools.com/tags/ref_httpmethods.asp by HTTrack Website Copier/3.x [XR&CO'2014], Sun, 13 Mar 2016 11:03:53 GMT -->
<head>
...
<div class="chapter">
<div class="prev"><a class="chapter" href="ref_httpmessages.html">&laquo; Previous</a></div>
<div class="next"><a class="chapter" href="ref_pxtoemconversion.html">Next Reference &raquo;</a></div>
</div>
<hr>
...
<p><b>Note that the query string (name/value pairs) is sent in the URL of 
a GET request:</b></p>
...
<p><b>Note that the query string (name/value pairs) is sent in the HTTP message body of a POST request:</b></p>
<div class="w3-code w3-border notranslate">
	<div>
